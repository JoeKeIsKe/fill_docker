...
function Accect(props: Props) {
  ...
  return (
    <div className={`bg-white rounded-t-2xl p-4 ${className}`}>
      <Input
        value={value}
        onChange={(e) => setValue(e.target.value)}
        suffix={
          <span
            className="bg-red-700 px-2.5 py-2.5 rounded cursor-pointer"
      ...
      <Button className="w-full mt-4 btn-default" onClick={handleClick}>
        Deposit
      </Button>
    </div>
  );
